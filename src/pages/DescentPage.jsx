    ...
    <div className="descent-page">
      ...
      <div className="descent-right">
        ...
        <p className="descent-description">
          What may surprise many is that the <span className="highlight-text">descent from Mount Everest is often more dangerous than the climb</span> to the summit itself. Between <span className="highlight-text">1922 and 2025</span>, <span className="highlight-text">122 out of 339 documented deaths</span> occurred during descent. Many climbers push themselves to their physical and mental limits reaching the summit, leaving little energy, oxygen, or focus for the journey back down. <span className="highlight-text">Exhaustion and reduced decision-making</span> at extreme altitude often lead to fatal mistakes. The dangers of descent are influenced by several factors, including <span className="highlight-text">falls</span>, <span className="highlight-text">severe exhaustion</span>, <span className="highlight-text">exposure and frostbite</span>, <span className="highlight-text">altitude sickness</span>, <span className="highlight-text">avalanches</span>, and other high-altitude illnesses and complications.
        </p>
